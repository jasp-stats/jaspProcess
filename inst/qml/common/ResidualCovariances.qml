...
Group
{
	property bool independentCovariancesChecked: true
	property bool mediatorCovariancesChecked: false
	property bool dependentCovariancesChecked: false
	...
	CheckBox
	{
		...
		checked: independentCovariancesChecked
	}
	CheckBox
	{
		name: "mediatorCovariances"
		label: qsTr("Mediators")
		checked: mediatorCovariancesChecked
	}
	CheckBox
	{
		name: "dependentCovariances"
		label: qsTr("Dependent variables")
		checked: dependentCovariancesChecked
	}
}

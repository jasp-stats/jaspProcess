...
Group
{
	property bool conceptualPathPlotsChecked: 	true
	property bool statisticalPathPlotsChecked: 	false
	...
	CheckBox
	{
		...
		checked: conceptualPathPlotsChecked
	}
	CheckBox
	{
		name: "statisticalPathPlot"
		label: qsTr("Statistical")
		checked: statisticalPathPlotsChecked
	}
}

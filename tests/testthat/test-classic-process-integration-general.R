...
test_that("Factors with more than two levels work", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(-0.830256392676731, 0.671610737591095, 16, -0.0793228275428182,
                                      "facThreeB", "contNormal", "<unicode>", 0.835982155918959, 0.383136410187729,
                                      -0.207035472050155, -0.419840075271681, 0.605570327467686, 50,
                                      0.0928651260980023, "facThreeB", "contNormal", "<unicode>",
                                      0.722586733024018, 0.261589093174077, 0.355003815224835, -0.539700679220641,
                                      1.2482888689735, 84, 0.354294094876428, "facThreeB", "contNormal",
  ...
  jaspTools::expect_equal_tables(table,
                                 list(-0.830256392676731, 0.671610737591095, 16, -0.0793228275428182,
                                      "Total", 0.835982155918959, 0.383136410187729, -0.207035472050155,
                                      -0.419840075271681, 0.605570327467686, 50, 0.0928651260980023,
                                      "Total", 0.722586733024018, 0.261589093174077, 0.355003815224835,
                                      -0.539700679220641, 1.2482888689735, 84, 0.354294094876428,
                                      "Total", 0.437310753173408, 0.456128164164641, 0.776742421782455
                                 ))
...
test_that("Interactions between three-level and two-level factors work", {
  ...
  table <- results[["results"]][["parEstContainer"]][["collection"]][["parEstContainer_Model 1"]][["collection"]][["parEstContainer_Model 1_mediationEffectsTable"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(-0.79179509702597, 0.581685251376472, -0.105054922824749, 0, "facThreeB",
                                      "contNormal", "<unicode>", 0.76430843174253, 0.350384078288244,
                                      -0.299827901250483, -0.346979683280772, 1.19016835503621, 0.421594335877721,
                                      1, "facThreeB", "contNormal", "<unicode>", 0.282320764613395,
                                      0.39213680721733, 1.07512053986828))
  ...
  table <- results[["results"]][["parEstContainer"]][["collection"]][["parEstContainer_Model 1"]][["collection"]][["parEstContainer_Model 1_totalEffectsTable"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(-0.79179509702597, 0.581685251376472, -0.105054922824749, 0, "Total",
                                      0.76430843174253, 0.350384078288244, -0.299827901250483, -0.346979683280772,
                                      1.19016835503621, 0.421594335877721, 1, "Total", 0.282320764613395,
                                      0.39213680721733, 1.07512053986828))
...
test_that("Interactions between two-level and three-level factors work", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(-1.50982658901334, 0.360680618815769, -0.574572985098788, 0, 0,
                                      "facTwoE", "contNormal", "<unicode>", 0.228549486656783, 0.477178974354487,
                                      -1.20410373461247, -0.481073569262345, 0.385226116469709, -0.0479237263963183,
                                      1, 0, "facTwoE", "contNormal", "<unicode>", 0.828324822977639,
                                      0.220998878695046, -0.216850540958842, -1.50982658901334, 0.360680618815769,
                                      -0.574572985098788, 0, 0, "facTwoE", "contNormal", "<unicode>",
                                      0.228549486656783, 0.477178974354487, -1.20410373461247, -1.50982658901334,
                                      0.360680618815769, -0.574572985098788, 0, 0, "facTwoE", "contNormal",
                                      "<unicode>", 0.228549486656783, 0.477178974354487, -1.20410373461247,
                                      -0.481073569262345, 0.385226116469709, -0.0479237263963183,
                                      1, 0, "facTwoE", "contNormal", "<unicode>", 0.828324822977639,
                                      0.220998878695046, -0.216850540958842, -1.50982658901334, 0.360680618815769,
                                      -0.574572985098788, 0, 0, "facTwoE", "contNormal", "<unicode>",
                                      0.228549486656783, 0.477178974354487, -1.20410373461247, -0.864792807812527,
                                      0.720584645814155, -0.0721040809991859, 0, 1, "facTwoE", "contNormal",
                                      "<unicode>", 0.858502237173678, 0.404440455572637, -0.178281079465939,
                                      -0.845713837967434, 1.754804193374, 0.454545177703284, 1, 1,
                                      "facTwoE", "contNormal", "<unicode>", 0.493239705610856, 0.663409647282805,
                                      0.685165160870077, -0.864792807812527, 0.720584645814155, -0.0721040809991859,
                                      0, 1, "facTwoE", "contNormal", "<unicode>", 0.858502237173678,
                                      0.404440455572637, -0.178281079465939))
  ...
  jaspTools::expect_equal_tables(table,
                                 list(-1.50982658901334, 0.360680618815769, -0.574572985098788, 0, 0,
                                      "Total", 0.228549486656783, 0.477178974354487, -1.20410373461247,
                                      -0.481073569262345, 0.385226116469709, -0.0479237263963183,
                                      1, 0, "Total", 0.828324822977639, 0.220998878695046, -0.216850540958842,
                                      -1.50982658901334, 0.360680618815769, -0.574572985098788, 0,
                                      0, "Total", 0.228549486656783, 0.477178974354487, -1.20410373461247,
                                      -1.50982658901334, 0.360680618815769, -0.574572985098788, 0,
                                      0, "Total", 0.228549486656783, 0.477178974354487, -1.20410373461247,
                                      -0.481073569262345, 0.385226116469709, -0.0479237263963183,
                                      1, 0, "Total", 0.828324822977639, 0.220998878695046, -0.216850540958842,
                                      ...
                                      0, 1, "Total", 0.858502237173678, 0.404440455572637, -0.178281079465939,
                                      -0.845713837967434, 1.754804193374, 0.454545177703284, 1, 1,
                                      "Total", 0.493239705610856, 0.663409647282805, 0.685165160870077,
                                      -0.864792807812527, 0.720584645814155, -0.0721040809991859,
                                      0, 1, "Total", 0.858502237173678, 0.404440455572637, -0.178281079465939
                                 ))
